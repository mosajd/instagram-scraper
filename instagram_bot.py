...
class InstagramBot:
    ...
    def GetFollowersNumber(self):
        followers_number = self.driver.find_element_by_xpath('/html/body/div[1]/section/main/div/header/section/ul/li[2]/a/span').get_attribute('title')
        time.sleep(3)
    ...
    def PressTabKey(self,repetition,time_sleep):
    ...
    def PressPageDownKey(self,repetition,time_sleep):
        self.repetition = repetition
        self.time_sleep = time_sleep
        # number of times you want to press the key
    ...
    def CollectFollowers(self):
        
        for i in range(1,30):                                                                 
            temp = self.driver.find_element_by_xpath(f'/html/body/div[4]/div/div/div[2]/ul/div/li[{i}]/div/div[1]/div[2]/div[1]/span/a').get_attribute('title')
...
test.Login()
test.DiscardPopup()
test.GetFollowersNumber()
test.OpenLink(followers_link)
test.PressTabKey(2, 3)
test.PressPageDownKey(4, 7)
test.PressTabKey(1, 6)
test.CollectFollowers()
test.PrintResults()
test.Quit
